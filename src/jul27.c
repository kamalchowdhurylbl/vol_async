                          ...
                          hid_t mem_space_id, hid_t file_space_id, hid_t plist_id, const void *buf)
{
    ...
    return_task_val =
        foreach_iter_task(aid, parent_obj, mem_type_id, mem_space_id, file_space_id, plist_id, buf, NULL);
    // for(int i=0;return_val!=0;i++)
    // return_val =foreach_iter_task(aid, parent_obj, mem_type_id, mem_space_id,
    // file_space_id,plist_id, buf);

    while (return_task_val != NULL) {
        return_task_val = foreach_iter_task(aid, parent_obj, mem_type_id, mem_space_id, file_space_id,
