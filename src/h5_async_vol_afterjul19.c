                          ...
                          hid_t mem_space_id, hid_t file_space_id, hid_t plist_id, const void *buf)
{
    ...
    // return_val=2;
    return_val = foreach_iter_task(aid, parent_obj, mem_type_id, mem_space_id, file_space_id, plist_id, buf,
                                   return_val);
    for (int i = 0; return_val != NULL; i++)
        return_val = foreach_iter_task(aid, parent_obj, mem_type_id, mem_space_id, file_space_id, plist_id,
                                       buf, return_val);
    // fprintf(stderr,"this is before H5Sget_select_type\n");
