...
static async_task_t *
foreach_iter_task(async_instance_t *aid, H5VL_async_t *parent_obj, hid_t mem_type_id, hid_t mem_space_id,
                  hid_t file_space_id, hid_t plist_id, const void *buf, async_task_t *prev_task)
{
    ...
    fprintf(stderr, "this is beginning of func\n");
    ...
    DL_FOREACH(async_instance_g->qhead.queue, task_list_iter)
    {
        ...
        {
            fprintf(stderr, "in the foreach1\n");
            if (task_iter->func == async_dataset_write_fn) {
                fprintf(stderr, "in the foreach2\n");
                          ...
                          hid_t mem_space_id, hid_t file_space_id, hid_t plist_id, const void *buf)
{
    ...
    // return_val=2;
    // return_val =foreach_iter_task(aid, parent_obj, mem_type_id, mem_space_id,
    //                 file_space_id,plist_id, buf,return_val);
